							...
							<PanelRow className="lsq-panel__row">
								...
								>
									...
									<div className="lsq-panel__footer">
										<p><a href="https://docs.lemonsqueezy.com/" target="_blank" rel="noreferrer">{__('View API documentation', 'lemonsqueezy')}</a></p>
